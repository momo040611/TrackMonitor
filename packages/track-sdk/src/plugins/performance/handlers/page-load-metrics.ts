 ...
 * 页面加载性能处理器类型 
 */ 
export type PageLoadMetricsHandler = (metricType: PerformanceMetricType, metrics: PageLoadMetrics, metadata?: Record<string, any>) => void; 
/** 
 * 初始化页面加载性能监控 
          ...
          switch (entry.entryType) {
            ...
            case 'layout-shift':
              ...
              if (!layoutShift.hadRecentInput) {
                metrics.cumulativeLayoutShift = (metrics.cumulativeLayoutShift || 0) + layoutShift.value;
              }
              break;
          }
        });
