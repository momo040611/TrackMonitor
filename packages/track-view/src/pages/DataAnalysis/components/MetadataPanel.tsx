...
import { Card, Tabs, Table, Tag, Typography, Form, Input, Switch, Button, Space, Popconfirm } from 'antd'
import type { ColumnsType } from 'antd/es/table'
import {
    metadataInitialState,
    metadataReducer,
} from '../../../store/modules/metadata'
import {
    loadInitialMetadata,
                                        ...
                                        ...tagColumns,
                                        {
                                            ...
                                            render: (_, record) => (
                                                <Popconfirm
                                                    title="确认删除该标签？"
                                                    onConfirm={() =>
                                                        dispatch({ type: 'removeTag', payload: record.name })
                                                    }
                                                >
                                                    <Button type="link" size="small">
                                                        删除
